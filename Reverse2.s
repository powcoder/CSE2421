...
loop:				#loop to sum values in array 
    ...
    decq %r15			#decrement number of remaining elements
    jl exit			#jump out of loop if no elements remaining
    movslq (%r13,%r15,4), %rax	#read integer value and sign extend to a long
    movq %rax, (%r14, %r12,8)   #write long value to Reverse array position
